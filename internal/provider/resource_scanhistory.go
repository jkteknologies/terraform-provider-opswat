...
var (
	...
	_ resource.ResourceWithImportState = &scanHistory{}
)
...
func (r *scanHistory) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
